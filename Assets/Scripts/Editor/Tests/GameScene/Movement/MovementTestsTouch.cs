...
{
    public class MovementTestsTouch : MovementTests
    {
        [Test]
        public override void CheckMoveRight()
        {
            ...
            int fingerId = AltDriver.BeginTouch(button.GetScreenPosition());
        ...
        public override void CheckJump()
        {
            ...
            fingerId = AltDriver.BeginTouch(button.GetScreenPosition());
            AltDriver.EndTouch(fingerId);
            player = FindPlayer();
